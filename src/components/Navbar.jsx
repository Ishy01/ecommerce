...
const Navbar = () => {
  return (
    <div className="shadow-md bg-white dark:border-gray-900 dark:text-white duration-200 relative z-40 ">
        ...
        <div className="container flex justify-between items-center">
          ...
          <div className="flex justify-between items-center gap-4">
            <div className="relative group hidden sm:block">
              ...
              />
              <IoMdSearch className="text-gray-500 group-hover:text-primary absolute top-1/2 -translate-y-1/2 right-3 dark:text-primary" />
            </div>
            <button
      ...
      {/* lower Navbar */}
      <div className="flex justify-center bg-white dark:bg-gray-900 duration-200">
