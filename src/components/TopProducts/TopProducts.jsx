...
const ProductsData = [
    {
        ...
        img: shirt,
        title: "Casual Wear",
        description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni quia iste, facere autem maiores maxime.",
    },
    {
        id: 2,
        img: shirt2,
          ...
          {ProductsData.map((data) => (
            <div className="rounded-2xl bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px]">
                ...
                <div className="p-4 text-center">
                    ...
                    <h1 className="text-xl font-bond">{data.title}</h1>
